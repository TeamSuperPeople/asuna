...
public class Blocks {
    ...
    public static final Block BURNING_MANA_GENERATOR = register("burning_mana_generator", new BurningManaGeneratorBlock(), new Item.Settings().group(Asuna.ASUNA_SPELLS));
